...
class Telegram {
  ...
  Future<WebhookInfo> getWebhookInfo() async {
    return _client.httpGet('${_baseUrl}${_token}/getWebhookInfo',
        returnType: new WebhookInfo());
  }

  /// [https://core.telegram.org/bots/api#getme](https://core.telegram.org/bots/api#getme)
  Future<User> getMe() async {
    return _client.httpGet('${_baseUrl}${_token}/getMe',
        returnType: new User());
  }
  ...
  Future<Message> sendMessage(chat_id, String text,
    ...
    Map body = {
      ...
      'disable_web_page_preview': (disable_web_page_preview == null
          ? ''
          : '${disable_web_page_preview}'),
      'disable_notification':
          (disable_notification == null ? '' : '${disable_notification}'),
      'reply_to_message_id':
          (reply_to_message_id == null ? '' : '${reply_to_message_id}'),
  ...
  Future<Message> sendPhoto(chat_id, photo,
    ...
    if (photo is io.File) {
      ...
      return _client.httpMultipartPost(requestUrl, file,
          body: body, returnType: new Message());
  ...
  Future<Message> sendVideo(chat_id, video,
    ...
    Map body = {
      ...
      'parse_mode': (parse_mode == null ? '' : '${parse_mode}'),
      'supports_streaming':
          (supports_streaming == null ? '' : '${supports_streaming}'),
      'disable_notification':
          (disable_notification == null ? '' : '${disable_notification}'),
      'reply_to_message_id':
          (reply_to_message_id == null ? '' : '${reply_to_message_id}'),
  ...
  Future<bool> restrictChatMember(chat_id, int user_id,
    ...
    Map body = {
      ...
      'until_date': (until_date == null ? '' : '${until_date}'),
      'can_send_messages':
          (can_send_messages == null ? '' : '${can_send_messages}'),
      'can_send_media_messages':
          (can_send_media_messages == null ? '' : '${can_send_media_messages}'),
      'can_send_other_messages':
          (can_send_other_messages == null ? '' : '${can_send_other_messages}'),
      'can_add_web_page_previews': (can_add_web_page_previews == null
          ? ''
  ...
  Future<bool> promoteChatMember(chat_id, int user_id,
    ...
    Map body = {
      ...
      'can_post_messages':
          (can_post_messages == null ? '' : '${can_post_messages}'),
      'can_edit_messages':
          (can_edit_messages == null ? '' : '${can_edit_messages}'),
      'can_delete_messages':
          (can_delete_messages == null ? '' : '${can_delete_messages}'),
      'can_invite_users':
          (can_invite_users == null ? '' : '${can_invite_users}'),
      'can_restrict_members':
          (can_restrict_members == null ? '' : '${can_restrict_members}'),
      'can_pin_messages':
          (can_pin_messages == null ? '' : '${can_pin_messages}'),
      'can_promote_members':
          (can_promote_members == null ? '' : '${can_promote_members}')
    };
    return _client.httpPost(requestUrl, body: body);
  }
  ...
  Future<ChatMember> getChatMember(chat_id, int user_id) async {
    ...
    Map body = {'chat_id': '${chat_id}', 'user_id': '${user_id}'};
    return _client.httpPost(requestUrl,
        body: body, returnType: new ChatMember());
  }
  ...
  Future<bool> createNewStickerSet(
    ...
    Map body = {
      ...
      'mask_position':
          (mask_position == null ? '' : _dson.encode(mask_position))
    };
  ...
  Future<bool> answerInlineQuery(
    ...
    Map body = {
      ...
      'switch_pm_parameter':
          (switch_pm_parameter == null ? '' : switch_pm_parameter)
    };
    return _client.httpPost(requestUrl, body: body);
  }
  ...
  Future<Message> sendInvoice(
    ...
    Map body = {
      ...
      'need_phone_number':
          (need_phone_number == null ? '' : '${need_phone_number}'),
      'need_email': (need_email == null ? '' : '${need_email}'),
      'need_shipping_address':
          (need_shipping_address == null ? '' : '${need_shipping_address}'),
      'send_phone_number_to_provider': (send_phone_number_to_provider == null
          ? ''
          : '${send_phone_number_to_provider}'),
      'send_email_to_provider':
          (send_email_to_provider == null ? '' : '${send_email_to_provider}'),
  ...
  Future<bool> answerShippingQuery(String shipping_query_id, bool ok,
    ...
    Map body = {
      ...
      'ok': '${ok}',
      'shipping_options':
          (shipping_options == null ? '' : _dson.encode(shipping_options)),
  ...
  Future<Message> setGameScore(int user_id, int score,
    ...
    Map body = {
      ...
      'disable_edit_message':
          (disable_edit_message == null ? '' : '${disable_edit_message}'),
      'chat_id': (chat_id == null ? '' : '${chat_id}'),
      'message_id': (message_id == null ? '' : '${message_id}'),
      'inline_message_id': (inline_message_id == null ? '' : inline_message_id)
    };
